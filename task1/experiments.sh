...
echo "Mesure, 1 thread, 2 threads, 4 threads, 8 threads, 16 threads, 32 threads" > data/task1_3.csv
...
do
    ...
    do
        ...
        time=$(/usr/bin/time -f %e ./task1_3 $arg $arg 2>&1)
    ...
    echo $i,${readerwriterArray[*]} | tr ' ' ',' >> data/task1_3.csv
